...
do 
    ...
    python __main__.py --nagents 100 --ngroups 20 --nrounds 75 --generations 125 --groomagents 2 --gossipagents 2 --gossipeffect 4 --groomeffect 5
done 

for i in {1..10}
do 
    echo "Running with simuluation: $i from gossip 3 and grooming 5"
    python __main__.py --nagents 100 --ngroups 20 --nrounds 75 --generations 125 --groomagents 2 --gossipagents 2 --gossipeffect 3 --groomeffect 5
done 

for i in {1..10}
do 
    echo "Running with simuluation: $i from gossip 2 and grooming 5"
    python __main__.py --nagents 100 --ngroups 20 --nrounds 75 --generations 125 --groomagents 2 --gossipagents 2 --gossipeffect 2 --groomeffect 5
done 

for i in {1..10}
do 
    echo "Running with simuluation: $i from gossip 1 and grooming 5"
    python __main__.py --nagents 100 --ngroups 20 --nrounds 75 --generations 125 --groomagents 2 --gossipagents 2 --gossipeffect 1 --groomeffect 5
done 
